export const codeTabsDisabled = `import React from "react";
...
export const codeTabsDisabledItem = `import React from "react";
import { Tabs, Tab } from "@/lib/components/tab";
...
export const App = () => {
  ...
  return (
    <Tabs disabledKeys={new Set(["music"])} items={tabs}>
      {(item) => (
        <Tab key={item.id} title={item.title}>
          <section>
            <div>
